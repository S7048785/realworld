...
export default function ButtonCreativeRight() {
	return (
			<>
				<div
						className='group relative cursor-pointer px-1.5 py-0.5 w-32 border rounded-full overflow-hidden text-gray-500 text-center '>
        <span
          ...
          <span className="text-sm pl-2">
					...
					<div
							className='flex gap-2 text-white z-10 items-center absolute top-0 h-full w-full justify-center translate-x-12 opacity-0 group-hover:-translate-x-1 group-hover:opacity-100 transition-all duration-300 text-sm'>
						<span>Read More</span>
						<ArrowRight size={16}/>
					</div>
					<div
